...
# Oleg: please keep record_tabular(), dump logkv(). Reason is you can remember and search "tabular" but you can't search "kv". As an
# instance of general rule is to avoid top-20 programming terms to name things.
